...
return [
    ...
    'Firebase Cloud Messaging -> Web Push certificates -> Key pair' => 'Firebase Cloud Benachrichtigungen - Web Push Zertifikate - Schlüsselpaar',
    ...
    'Key pair of the Web Push certificates' => 'Schlüsselpaar des Web Push Zertifikats',
    'Paste the content of the service account JSON files here. You can find more information in the module instructions.' => 'Füge hier den Inhalt des Service Kontos der JSON Dateien hier ein. Du findest weiterführende Informationen hierzu in der Modul Beschreibung.',
    ...
    'Use this ID to register your API Key.' => 'Nutze diese ID um den API Schlüssel zu registrieren.',
