...
return [
  ...
  'Please enable <a href="{url}" target="_blank">Pretty URLs</a> for proper working of the well-known files.' => 'Aktivér venligst <a href="{url}" target="_blank">Pretty URLs</a> for at få de velkendte filer til at fungere korrekt.',
  ...
  'URL to the file {fileNameLink}' => 'URL til filen {fileNameLink}.',
  'Use this ID to register your API Key.' => '',
  'Web API Key' => '',
  'Web App ID' => '',
  'Well-known file {fileName}' => 'Velkendt fil {fileName}',
];
